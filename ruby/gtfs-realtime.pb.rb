...
### <proto file: gtfs-realtime.proto>
...
::Protobuf::OPTIONS[:"java_package"] = "com.google.transit.realtime"
module TransitRealtime
  class FeedMessage < ::Protobuf::Message
    defined_in __FILE__
    required :FeedHeader, :header, 1
    repeated :FeedEntity, :entity, 2
  end
  class FeedHeader < ::Protobuf::Message
    ...
    class Incrementality < ::Protobuf::Enum
      defined_in __FILE__
      FULL_DATASET = value(:FULL_DATASET, 0)
      DIFFERENTIAL = value(:DIFFERENTIAL, 1)
    end
    optional :Incrementality, :incrementality, 2, :default => :FULL_DATASET
    optional :uint64, :timestamp, 3
    extensions 1000..1999
  end
  class FeedEntity < ::Protobuf::Message
    defined_in __FILE__
    required :string, :id, 1
    optional :bool, :is_deleted, 2, :default => false
    optional :TripUpdate, :trip_update, 3
  ...
  class TripUpdate < ::Protobuf::Message
    ...
    required :TripDescriptor, :trip, 1
    optional :VehicleDescriptor, :vehicle, 3
    class StopTimeEvent < ::Protobuf::Message
      defined_in __FILE__
      optional :int32, :delay, 1
      optional :int64, :time, 2
      optional :int32, :uncertainty, 3
    ...
    class StopTimeUpdate < ::Protobuf::Message
      ...
      class ScheduleRelationship < ::Protobuf::Enum
        ...
        SKIPPED = value(:SKIPPED, 1)
        NO_DATA = value(:NO_DATA, 2)
      end
  ...
  class VehiclePosition < ::Protobuf::Message
    ...
    class VehicleStopStatus < ::Protobuf::Enum
      defined_in __FILE__
      INCOMING_AT = value(:INCOMING_AT, 0)
      STOPPED_AT = value(:STOPPED_AT, 1)
      IN_TRANSIT_TO = value(:IN_TRANSIT_TO, 2)
    end
    optional :VehicleStopStatus, :current_status, 4, :default => :IN_TRANSIT_TO
    optional :uint64, :timestamp, 5
    class CongestionLevel < ::Protobuf::Enum
      defined_in __FILE__
      UNKNOWN_CONGESTION_LEVEL = value(:UNKNOWN_CONGESTION_LEVEL, 0)
      RUNNING_SMOOTHLY = value(:RUNNING_SMOOTHLY, 1)
      STOP_AND_GO = value(:STOP_AND_GO, 2)
      CONGESTION = value(:CONGESTION, 3)
  ...
  class Alert < ::Protobuf::Message
    ...
    class Cause < ::Protobuf::Enum
      defined_in __FILE__
      UNKNOWN_CAUSE = value(:UNKNOWN_CAUSE, 1)
      OTHER_CAUSE = value(:OTHER_CAUSE, 2)
      TECHNICAL_PROBLEM = value(:TECHNICAL_PROBLEM, 3)
      STRIKE = value(:STRIKE, 4)
      DEMONSTRATION = value(:DEMONSTRATION, 5)
      ACCIDENT = value(:ACCIDENT, 6)
      HOLIDAY = value(:HOLIDAY, 7)
      WEATHER = value(:WEATHER, 8)
      MAINTENANCE = value(:MAINTENANCE, 9)
      CONSTRUCTION = value(:CONSTRUCTION, 10)
      POLICE_ACTIVITY = value(:POLICE_ACTIVITY, 11)
      MEDICAL_EMERGENCY = value(:MEDICAL_EMERGENCY, 12)
    end
    optional :Cause, :cause, 6, :default => :UNKNOWN_CAUSE
    class Effect < ::Protobuf::Enum
      defined_in __FILE__
      NO_SERVICE = value(:NO_SERVICE, 1)
      REDUCED_SERVICE = value(:REDUCED_SERVICE, 2)
      SIGNIFICANT_DELAYS = value(:SIGNIFICANT_DELAYS, 3)
      DETOUR = value(:DETOUR, 4)
      ADDITIONAL_SERVICE = value(:ADDITIONAL_SERVICE, 5)
      MODIFIED_SERVICE = value(:MODIFIED_SERVICE, 6)
      OTHER_EFFECT = value(:OTHER_EFFECT, 7)
      UNKNOWN_EFFECT = value(:UNKNOWN_EFFECT, 8)
      STOP_MOVED = value(:STOP_MOVED, 9)
    end
    optional :Effect, :effect, 7, :default => :UNKNOWN_EFFECT
    optional :TranslatedString, :url, 8
    optional :TranslatedString, :header_text, 10
  ...
  class TripDescriptor < ::Protobuf::Message
    ...
    class ScheduleRelationship < ::Protobuf::Enum
      ...
      SCHEDULED = value(:SCHEDULED, 0)
      ADDED = value(:ADDED, 1)
      UNSCHEDULED = value(:UNSCHEDULED, 2)
      CANCELED = value(:CANCELED, 3)
    end
    optional :ScheduleRelationship, :schedule_relationship, 4
    extensions 1000..1999
  end
  ...
  class EntitySelector < ::Protobuf::Message
    defined_in __FILE__
    optional :string, :agency_id, 1
    optional :string, :route_id, 2
    optional :int32, :route_type, 3
  ...
  class TranslatedString < ::Protobuf::Message
    defined_in __FILE__
    class Translation < ::Protobuf::Message
      defined_in __FILE__
      required :string, :text, 1
      optional :string, :language, 2
    end
